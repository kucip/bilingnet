              ...
              <tr>
                ...
                <td>
                  <center>
                    ...
                    <a onclick="grid_edit({{$pmKey}})" style=" color: green; padding:4px;max-width: 30px;max-height: 30px;"><i class="icon-pencil" aria-hidden="true"></i></a>
...
<script type="text/javascript">
  function save() {
    var jenis = document.getElementById('id').value;
    if (jenis == '') {
      saveNew('id');
    } else {
      saveEdit('id');
  ...
  function saveNew(primaryKey) {
    ...
    if (pass.length < 4) {
      alertify.error('Pasword minimal 4 karakter');
      return;
    }
