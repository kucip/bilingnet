        ...
        <form id="form" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col-sm-{{$dataform['col'] ?? 12}}">
              <div class="form-group">
                <label class="form-label"><b>{{$dataform['label']}}</b></label>
                <input type="file" class="form-control-uniform" id="{{$dataform['field']}}" name="{{$dataform['field']}}" placeholder="{{$dataform['placeholder']}}">
                <small class="form-text text-muted">{{$dataform['keterangan']}}</small>
              </div>
            </div>
          ...
          <div class="text-right">
            <button type="submit" id="form" class="btn btn-sm btn-primary" onclick="save()"><i class="icon-floppy-disk"> </i> Save</button>
          </div>
        </form>
      </div>
    </div>
