  ...
  <div class="col-md-4">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-sm-{{$dataform['col'] ?? 12}}">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="{{$dataform['field']}}" name="{{$dataform['field']}}" placeholder="{{$dataform['placeholder']}}" {{$dataform['disable']}}>
          ...
          <div class="col-sm-{{$dataform['col'] ?? 12}}">
            <div class="form-group">
              <label class="form-label"><b>{{$dataform['label']}}</b></label>
              <input type="number" class="form-control" id="{{$dataform['field']}}" name="{{$dataform['field']}}" placeholder="{{$dataform['placeholder']}}" {{$dataform['disable']}}>
              <small class="form-text text-muted">{{$dataform['keterangan']}}</small>
            </div>
          </div>
          ...
          <div class="col-sm-{{$dataform['col'] ?? 12}}">
            <label class="form-label"><b>{{$dataform['label']}}</b></label>
            <div class="form-group">
              <select name="{{$dataform['field']}}" id="{{$dataform['field']}}" class="form-control {{$dataform['field']}}" {{$dataform['disable']}}>
          ...
          <div class="col-sm-{{$dataform['col'] ?? 12}}">
            <div class="form-group">
              ...
              <select name="{{$dataform['field']}}" id="{{$dataform['field']}}" class="{{$dataform['field']}} form-control" style="width: 100%;" {{$dataform['disable']}}>
                <option value="">{{$dataform['default']}}</option>
              </select>
              <small class="form-text text-muted">{{$dataform['keterangan']}}</small>
              <script type="text/javascript">
        ...
        <div class="text-right">
          <button type="submit" class="btn btn-sm btn-primary" onclick="save()"><i class="icon-floppy-disk"> </i> Posting Ke Ipaymu</button>
        </div>
        <!-- </form> -->
      </div>
    </div>
